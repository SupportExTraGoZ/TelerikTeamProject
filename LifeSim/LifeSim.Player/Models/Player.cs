...
namespace LifeSim.Player.Models
{
    public class Player : AbstractPlayer
    {
        ...
        public Player(string firstname, string lastname, GenderType gender, Birthplaces birthplace, IFamilyGenerator familyGenerator) : base(firstname, lastname, gender, birthplace)
        {
            ...
            this.Father = new Parent(fatherName[0], fatherName[1], GenderType.Male, familyGenerator.ChooseBirthplace(), familyGenerator);
            this.Mother = new Parent(motherName[0], motherName[1], GenderType.Female, familyGenerator.ChooseBirthplace(), familyGenerator);
        }
    }
}