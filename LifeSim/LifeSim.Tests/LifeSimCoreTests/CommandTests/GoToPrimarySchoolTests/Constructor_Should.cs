...
namespace LifeSim.Tests.LifeSimCoreTests.CommandTests.GoToPrimarySchoolTests
{
    [TestClass]
    public class Constructor_Should
    {
        ...
        public void CreateInstance_When_CorrectParametersArePassed()
        {
            ...
            var command = new GoToPrimarySchoolCommand(engineMock.Object, gameFactoryMock.Object);
